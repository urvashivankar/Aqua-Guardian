...
import successChilika from '@/assets/success_story_chilika.png';
import successMumbai from '@/assets/success_story_mumbai.png';
import successKerala from '@/assets/success_story_kerala.png';
